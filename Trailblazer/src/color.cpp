 ...
 *
 * TODO: remove this code and just use code from library gcolor.cpp
 *
 ...
 * of the Color type.
 */
static const int COLOR_MULTIPLIERS[7][3] = {
    {   0,   0,   0 },   // UNCOLORED
    { 255, 255, 255 },   // WHITE
    { 192, 192, 192 },   // GRAY
    { 255, 255,   0 },   // YELLOW
...
int grayscaleToRGB(double brightness) {
    ...
    int rgb = static_cast<int>(brightness * 255);
...
void scaleBrightness(double brightness, int& r, int& g, int& b) {
    ...
    r = static_cast<int>(brightness * r);
    g = static_cast<int>(brightness * g);
    b = static_cast<int>(brightness * b);
}
